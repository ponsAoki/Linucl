...
export const QuizAnswerCard: FC<Props> = memo((props) => {
  ...
  return (
    <button
      className="bg-black text-white border-white border rounded p-4 hover:opacity-70 font-bold text-2xl m-6 md:mx-6 md:inline block mx-auto shadow-lg shadow-zinc-500"
